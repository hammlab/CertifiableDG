...
from models import representationNN, classificationNN, representationNN_small, domain_predictor
...
domain_classifier = domain_predictor(encoder, 2, 128)
...
def train_step_da_1(main_data, main_labels, domain_data, opposite_domain_labels):
    ...
    with tf.GradientTape(persistent=True) as tape:
        ...
        shared_domain = encoder(domain_data, training=True)
...
for epoch in range(EPOCHS):
    ...
    if epoch % 100 == 0:
        ...
        print("Disc:", eval_accuracy(x_combined, y_dc_correct_combined, encoder, domain_classifier))
