...
from utils import load_VLCS, eval_accuracy, mini_batch_class_balanced, eval_accuracy_disc, compute_WD, eval_accuracy_cdan
    ...
    for batch in range(nb_batches_train):
        ...
        if epoch >= PRETRAIN_STEPS:
            ...
            for _ in range(ADV_STEPS):
                ...
                if FACTOR == 0.75:
                    GAMMA = np.clip(GAMMA - 0.001 * grad_GAMMA, 1E-5, 1E3)
                else:
