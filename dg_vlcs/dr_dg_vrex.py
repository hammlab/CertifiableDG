...
for epoch in range(EPOCHS):
    ...
    if epoch % 2 == 0:   
        ...
        WDs_sadv = compute_WD(encoded_src_train_images, src_train_labels, encoded_src_train_images_adv, src_train_labels, NUM_CLASSES)
        WDs_target = compute_WD(encoded_src_train_images, src_train_labels, encoded_trg_test_images, trg_test_labels, NUM_CLASSES)
        RHO = FACTOR * WDs_sadv
