...
from utils import load_VLCS, eval_accuracy,  eval_accuracy_disc, compute_WD, mini_batch_class_balanced
...
optimizer_pretrain_encoder = tf.keras.optimizers.Adam(1E-4, beta_1=0.5)
