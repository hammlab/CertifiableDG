...
from utils import load_PACS, eval_accuracy, mini_batch_class_balanced
...
parser.add_argument('--METHOD', type=str, default="DANN", help='DANN')
...
domain_classifier = domain_predictor(2, REP_DIM)
